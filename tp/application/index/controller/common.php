...
function sendmail($tomail,$title,$body)
{
    ...
    $mail->Username = "baoshan01@126.com";// 发送方的邮箱用户名，就是自己的邮箱名
    $mail->Password = "baoshan0290";// 发送方的邮箱密码，不是登录密码,是qq的第三方授权登录码,要自己去开启,在邮箱的设置->账户->POP3/IMAP/SMTP/Exchange/CardDAV/CalDAV服务 里面
    //$mail->SMTPSecure = "ssl";// 使用ssl协议方式,
    $mail->Port = 25;// QQ邮箱的ssl协议方式端口号是465/587

    $mail->setFrom("baoshan01@126.com","倪宝山");// 设置发件人信息，如邮件格式说明中的发件人,
